export const StatusIndicator = ({ playing }) => {
	return (
	  <>
			{/* Sign Unit Container */}
			<div className="bg-gradient-to-b from-gray-800 to-gray-900 p-3 shadow-2xl border-2 border-gray-600">
				{/* Status Display */}
				<div className="bg-gradient-to-r from-gray-700 to-gray-800 p-4 border border-gray-500">
					...
					<div
						className={`w-full h-full py-4 px-0 font-bold text-4xl text-center shadow-inner transition-all duration-500 ${
							playing
